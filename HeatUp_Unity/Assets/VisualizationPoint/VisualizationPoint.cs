...
public class VisualizationPoint : PropertyAttribute { }


#if UNITY_EDITOR
[CustomEditor(typeof(MonoBehaviour), true)]
public class VisualizationPointDrawer : Editor
{
    ...
    public void OnSceneGUI()
    {
        ...
        while (property.Next(true))
        {
            if (property.propertyType == SerializedPropertyType.Vector3)
            {
                ...
                var draggablePoints = field.GetCustomAttributes(typeof(VisualizationPoint), false);
